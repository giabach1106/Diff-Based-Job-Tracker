...
class LLMEngine:
    ...
    def analyze_job(self, raw_html: str) -> JobAnalysis:
        ...
        user_prompt = (
            ...
            "Location priority rule (double-check before finalizing): set location_priority='preferred' for USA or fully Remote roles; "
            ...
            "Interpret US locations carefully: city + US state abbreviation/name is USA "
            "(e.g., Framingham, MA; Austin, TX; California (CA); Massachusetts (MA),...) and should be preferred. "
            "Only mark non_preferred when location is clearly outside the US and onsite. "
            "If a role lists both US and non-US locations, use neutral. "
